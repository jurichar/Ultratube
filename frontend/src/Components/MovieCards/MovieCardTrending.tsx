...
export default function MovieCardTrending() {
    return (
        <div className="flex-shrink-0 w-60 h-32 bg-quaternary rounded flex flex-col justify-between relative">
            <div className="opacity-0 w-full h-full bg-tertiary hover:opacity-100 rounded flex justify-center items-center" >
                Play
            </div>
            <BookmarkIcon />
